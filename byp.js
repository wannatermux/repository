...
function buildHeaders() {
    ...
    // Генерируем значения для Sec-CH-UA заголовков
    const uaVersion = "131";
    const fullVersion = "131.0.6778.85";
    ...
    const headers = {
        ...
        // Добавленные параметры Client Hints
        "sec-ch-ua": `\"Google Chrome\";v=\"${uaVersion}\", \"Chromium\";v=\"${uaVersion}\", \"Not_A Brand\";v=\"24\"`,
        "sec-ch-ua-mobile": platform === "\"Android\"" ? "?1" : "?0",
        "sec-ch-ua-platform": platform,
        "sec-ch-ua-arch": randomElement(archs),
        "sec-ch-ua-full-version-list": `\"Google Chrome\";v=\"${fullVersion}\", \"Chromium\";v=\"${fullVersion}\", \"Not_A Brand\";v=\"24.0.0.0\"`,
        "sec-ch-ua-model": platform === "\"Android\"" ? "\"Pixel 7\"" : "\"\"",
        "sec-ch-device-memory": randomElement(memories)
    };
